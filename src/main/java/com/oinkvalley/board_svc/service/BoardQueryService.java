...
public class BoardQueryService {
    ...
    public Page<PostSummaryResponse> getPostSummaries(Long boardId, Pageable pageable) {
        Pageable sorted = PageableSortDefaults.createdAtDescIfUnsorted(pageable);
        Page<PostBaseProjection> basePage = postRepository.findPostBaseList(boardId, sorted);
